...
class OrderLogic
{
    ...
    public static function create_transaction($order, $received_by=false, $status = null)
    {
        ...
        else
        {
            ...
            $order_amount = $order->order_amount - $order->additional_charge - $order->delivery_charge - $order->total_tax_amount - $dm_tips + $order->coupon_discount_amount + $store_discount_amount;
        ...
        try{
            ...
            $adminWallet->total_commission_earning = $adminWallet->total_commission_earning + $comission_amount + $order->additional_charge - $admin_subsidy- $admin_coupon_discount_subsidy -$store_discount_amount;
