                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="" autocomplete="new-password" id="password"
                                               name="password" required class="form-control"
                                               value="123456" minlength="8">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="" autocomplete="new-password" id="confirm_password"
                                               name="confirm_password" class="form-control" value="123456" required>
                                        <div class="togglePassword">
                                            <img
                                                src="{{asset('public/assets/installation')}}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">
