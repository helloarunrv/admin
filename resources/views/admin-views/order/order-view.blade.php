                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right">
                                    ...
                                    <dd class="col-6">
                                        ...
                                        {{ \App\CentralLogics\Helpers::format_currency($product_price + $del_c + $total_tax_amount + $total_addon_price + $deliverman_tips + $additional_charge - $coupon_discount_amount - $store_discount_amount) }}
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
    ...
    <script type="text/javascript">
        $(function() {
            $("#coba").spartanMultiImagePicker({
                ...
                maxCount: 6-{{ $order->order_proof?count(json_decode($order->order_proof)):0 }},
