    ...
    <div class="content container-fluid">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('public/assets/admin/img/slider-1.png')}}" loading="lazy"
                                                 alt="" class="dark-support rounded mw-100">
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset('public/assets/admin/img/slider-2.png')}}" loading="lazy"
                                                     alt="" class="dark-support rounded mb-4 mw-100">
                                                <p>
        ...
        <div class="card mb-5">
            <div class="card-body pl-md-10">
                <h4 class="mb-3 text-capitalize d-flex align-items-center">{{translate('upload_theme')}}</h4>
